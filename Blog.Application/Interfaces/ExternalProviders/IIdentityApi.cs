...
namespace Blog.Application.Interfaces.ExternalProviders
{
    ...
    /// in the form of <see cref="AuthorDto"/> objects, allowing the application to interact with the identity provider
    ...
    public interface IIdentityApi
    {
        ...
        /// <returns>A task representing the asynchronous operation. The task result contains the <see cref="AuthorDto"/> corresponding to the user, or null if not found.</returns>
        /// <remarks>
        /// This method sends a request to the external identity API to retrieve user information based on the provided
        /// user ID. If the user is found, the result contains the corresponding <see cref="AuthorDto"/> object.
        ...
        /// <returns>A task representing the asynchronous operation. The task result contains a list of <see cref="AuthorDto"/> objects corresponding to the users, or null if none are found.</returns>
        /// <remarks>
        /// This method sends a request to the external identity API to retrieve user information for multiple users.
        /// It accepts a list of user IDs and returns a list of <see cref="AuthorDto"/> objects for the users found.
