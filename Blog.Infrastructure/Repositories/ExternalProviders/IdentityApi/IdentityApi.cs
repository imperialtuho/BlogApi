...
namespace Blog.Infrastructure.Repositories.ExternalProviders.IdentityApi
{
    ...
    public class IdentityApi : WebApiClient, IIdentityApi
    {
        ...
        /// <returns>A <see cref="Task{AuthorDto}"/> containing the user data, or null if the user is not found.</returns>
        /// <remarks>
        ...
        /// <returns>A <see cref="Task{IList{AuthorDto}}"/> containing the list of users.</returns>
        /// <remarks>
